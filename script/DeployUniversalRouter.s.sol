...
abstract contract DeployUniversalRouter is Script {
    ...
    function getCreate3Factory() public view virtual returns (address) {
        return 0x38Ab3f2CE00973A51d3A2A04d634C9bcbf20e4e1;
    }

    function run() external returns (address router) {
        /// @dev address from https://github.com/pancakeswap/pancake-create3-factory
        Create3Factory factory = Create3Factory(getCreate3Factory());
